...
static void print_usage(FILE *out) {
    fprintf(out, "usage: ./hat_surrounds [--live-boundary] [--help]\n");
    fprintf(out, "Enumerate unique full-edge surrounds for the Hat seed\n");
    fprintf(out, "(fixed tile: tiles/hat.tile).\n");
    fprintf(out, "Depict with: ./hat_surrounds [--live-boundary] \
| ./imgtable > out.svg\n");
}
